...
typedef jvmtiIterationControl (JNICALL *jvmtiStackReferenceCallback)
    (jvmtiHeapRootKind root_kind, jlong class_tag, jlong size, jlong* tag_ptr, jlong thread_tag, jint depth, jmethodID method_t, jint slot, void* user_data);
...
union _jvmtiHeapReferenceInfo {
    jvmtiHeapReferenceInfoField field_t;
...
struct _jvmtiEnv {
  ...
  jvmtiError SetBreakpoint(jmethodID method_t,
            jlocation location) {
    return functions->SetBreakpoint(this, method_t, location);
  }

  jvmtiError ClearBreakpoint(jmethodID method_t,
            jlocation location) {
    return functions->ClearBreakpoint(this, method_t, location);
  }

  jvmtiError SetFieldAccessWatch(jclass klass,
            jfieldID field_t) {
    return functions->SetFieldAccessWatch(this, klass, field_t);
  }

  jvmtiError ClearFieldAccessWatch(jclass klass,
            jfieldID field_t) {
    return functions->ClearFieldAccessWatch(this, klass, field_t);
  }

  jvmtiError SetFieldModificationWatch(jclass klass,
            jfieldID field_t) {
    return functions->SetFieldModificationWatch(this, klass, field_t);
  }

  jvmtiError ClearFieldModificationWatch(jclass klass,
            jfieldID field_t) {
    return functions->ClearFieldModificationWatch(this, klass, field_t);
  }
  ...
  jvmtiError RetransformClasses(jint class_count,
            const jclass* loadedClasses) {
    return functions->RetransformClasses(this, class_count, loadedClasses);
  }
  ...
  jvmtiError GetFieldName(jclass klass,
            ...
            char** signature_ptr,
            char** generic_ptr) {
    return functions->GetFieldName(this, klass, field_t, name_ptr, signature_ptr, generic_ptr);
  }

  jvmtiError GetFieldDeclaringClass(jclass klass,
            jfieldID field_t,
            jclass* declaring_class_ptr) {
    return functions->GetFieldDeclaringClass(this, klass, field_t, declaring_class_ptr);
  }

  jvmtiError GetFieldModifiers(jclass klass,
            jfieldID field_t,
            jint* modifiers_ptr) {
    return functions->GetFieldModifiers(this, klass, field_t, modifiers_ptr);
  }

  jvmtiError IsFieldSynthetic(jclass klass,
            jfieldID field_t,
            jboolean* is_synthetic_ptr) {
    return functions->IsFieldSynthetic(this, klass, field_t, is_synthetic_ptr);
  }

  jvmtiError GetMethodName(jmethodID method_t,
            char** name_ptr,
            char** signature_ptr,
            char** generic_ptr) {
    return functions->GetMethodName(this, method_t, name_ptr, signature_ptr, generic_ptr);
  }

  jvmtiError GetMethodDeclaringClass(jmethodID method_t,
            jclass* declaring_class_ptr) {
    return functions->GetMethodDeclaringClass(this, method_t, declaring_class_ptr);
  }

  jvmtiError GetMethodModifiers(jmethodID method_t,
            jint* modifiers_ptr) {
    return functions->GetMethodModifiers(this, method_t, modifiers_ptr);
  }

  jvmtiError GetMaxLocals(jmethodID method_t,
            jint* max_ptr) {
    return functions->GetMaxLocals(this, method_t, max_ptr);
  }

  jvmtiError GetArgumentsSize(jmethodID method_t,
            jint* size_ptr) {
    return functions->GetArgumentsSize(this, method_t, size_ptr);
  }

  jvmtiError GetLineNumberTable(jmethodID method_t,
            jint* entry_count_ptr,
            jvmtiLineNumberEntry** table_ptr) {
    return functions->GetLineNumberTable(this, method_t, entry_count_ptr, table_ptr);
  }

  jvmtiError GetMethodLocation(jmethodID method_t,
            jlocation* start_location_ptr,
            jlocation* end_location_ptr) {
    return functions->GetMethodLocation(this, method_t, start_location_ptr, end_location_ptr);
  }

  jvmtiError GetLocalVariableTable(jmethodID method_t,
            jint* entry_count_ptr,
            jvmtiLocalVariableEntry** table_ptr) {
    return functions->GetLocalVariableTable(this, method_t, entry_count_ptr, table_ptr);
  }

  jvmtiError GetBytecodes(jmethodID method_t,
            jint* bytecode_count_ptr,
            unsigned char** bytecodes_ptr) {
    return functions->GetBytecodes(this, method_t, bytecode_count_ptr, bytecodes_ptr);
  }

  jvmtiError IsMethodNative(jmethodID method_t,
            jboolean* is_native_ptr) {
    return functions->IsMethodNative(this, method_t, is_native_ptr);
  }

  jvmtiError IsMethodSynthetic(jmethodID method_t,
            jboolean* is_synthetic_ptr) {
    return functions->IsMethodSynthetic(this, method_t, is_synthetic_ptr);
  }

  jvmtiError IsMethodObsolete(jmethodID method_t,
            jboolean* is_obsolete_ptr) {
    return functions->IsMethodObsolete(this, method_t, is_obsolete_ptr);
  }
